...
int find_status(char *add){
    int motorstatus;
    if(strncmp(add,"/C/RT",5)==0){
            motorstatus = 1000;
    }
    else if(strncmp(add,"/C/RB",5)==0){
        motorstatus = 100;
    }
    else if(strncmp(add,"/C/FR",5)==0){
        motorstatus = 1110;
    }
    else if(strncmp(add,"/B/FR",5)==0){
        motorstatus = 1110;
    }
    else if(strncmp(add,"/C/HS",5)==0){
        motorstatus = 1111;
    }
    else if(strncmp(add,"/B/HS",5)==0){
        motorstatus = 1111;
    }
    else if(strncmp(add,"/C/BA",5)==0){
        motorstatus = 1;
    }
            ...
            if(add[1] == 'C'){
                        ...
                        if(recv->getType() == 'I'){
                            ...
                            if(rxval == 'L')
                            {
                                pc.printf("LOW\r\n");
                                intensity = 0;
                                pc.printf("intensity changed to %d",intensity);
                            }
